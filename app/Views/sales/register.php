...
//JAO
            <tr><th>Price</th><td><?= $detalles['Price'] ?></td></tr>
            <tr><th>Comisión a Aplicar</th><td><?= $detalles['Comisión a Aplicar'] ?></td></tr>
            <tr><th>Cent1</th><td><?= $detalles['Cent1'] ?></td></tr>
            <tr><th>Monto Calculo Fee</th><td><?= $detalles['Monto Calculo Fee'] ?></td></tr>
            <tr><th>Fee</th><td><?= $detalles['Fee'] ?></td></tr>
            <tr><th>Subtotal</th><td><?= $detalles['Subtotal'] ?></td></tr>
            <tr><th>Cent2</th><td><?= $detalles['Cent2'] ?></td></tr>
            <tr><th>Given</th><td><?= $detalles['Given'] ?></td></tr>
            <tr><th>Monto Comisión Real</th><td><?= $detalles['Monto Comisión Real'] ?></td></tr>
